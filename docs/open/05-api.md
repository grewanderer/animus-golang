...
This guide summarizes the API surface and usage patterns exposed by the Animus gateway (closed-core). The canonical definitions are the OpenAPI specs in [open/api/openapi/](../../open/api/openapi/).
