...
export function MobileNav({ locale }: Props) {
  ...
  const copy: Record<Locale, { menu: string; close: string }> = {
  ...
  return (
    <div className="relative md:hidden">
      ...
      {open ? (
        <div
          id="mobile-nav-panel"
          className="absolute right-0 top-12 z-20 w-64 rounded-2xl border border-white/10 bg-[#0b1626]/95 p-3 shadow-[0_20px_40px_rgba(4,10,18,0.5)]"
        >
