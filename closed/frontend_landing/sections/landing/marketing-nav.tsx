...
export function MarketingNav({ locale }: Props) {
  ...
  return (
    <nav
      ref={navRef}
      className="hidden w-full items-center gap-4 overflow-x-auto text-sm text-white/70 md:order-3 md:flex md:basis-full md:flex-nowrap md:pb-1 xl:order-none xl:w-auto xl:basis-auto xl:gap-6 xl:overflow-visible"
    >
              ...
              <div className="inline-flex items-center gap-2">
                <Link
                  ...
                  className={cn(
                    ...
                    isActive ? 'font-semibold text-white' : undefined,
                  )}
