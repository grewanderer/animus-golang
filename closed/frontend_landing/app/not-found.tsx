...
import { createTranslator, defaultLocale, localizedPath, type Locale } from '@/lib/i18n';

export default function NotFound() {
  const copy: Record<Locale, { label: string; title: string; description: string; cta: string }> = {
    en: {
      label: 'Animus · 404',
  ...
  const t = createTranslator(defaultLocale, copy);
  return (
